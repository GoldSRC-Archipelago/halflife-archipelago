...
CBaseEntity* CBaseEntity::Create(const char* szName, const Vector& vecOrigin, const Vector& vecAngles, edict_t* pentOwner, bool bDropped)
{
	edict_t* pent;
	CBaseEntity* pEntity;
	...
	pEntity->pev->iuser4 = int(bDropped);
